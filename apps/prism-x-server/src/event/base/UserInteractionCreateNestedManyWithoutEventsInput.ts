...
@InputType()
class UserInteractionCreateNestedManyWithoutEventsInput {
...
export { UserInteractionCreateNestedManyWithoutEventsInput as UserInteractionCreateNestedManyWithoutEventsInput };
