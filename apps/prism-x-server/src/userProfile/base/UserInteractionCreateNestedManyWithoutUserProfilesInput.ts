...
@InputType()
class UserInteractionCreateNestedManyWithoutUserProfilesInput {
...
export { UserInteractionCreateNestedManyWithoutUserProfilesInput as UserInteractionCreateNestedManyWithoutUserProfilesInput };
