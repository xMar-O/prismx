...
@InputType()
class UserInteractionUpdateManyWithoutUserProfilesInput {
...
export { UserInteractionUpdateManyWithoutUserProfilesInput as UserInteractionUpdateManyWithoutUserProfilesInput };
